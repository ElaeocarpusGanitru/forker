						...
						<thead>
							<tr align="LEFT" valign="MIDDLE" id="TableTitle">
								<td width="300px" style="padding-left: 7px;">
									...
									onClick="$('[name=ids]').attr('checked', this.checked)" /> <label
									for="cbSelectAll">全选</label>
								</td>
							</tr>
						</thead>
								...
								<td>
									<ul id="tree">
										<s:iterator value="#application.privilegeList">
											<li><input type="checkbox" name="ids" value="${id}"
												id="${id}"
												<s:property value="%{id in ids ? 'checked' : ''}" />>
