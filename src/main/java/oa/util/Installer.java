...
public class Installer {
	...
	public void install()
	{
		...
		Privilege menu4 = new Privilege("待我审批", "/flow_myTaskList", menu);
		Privilege menu5 = new Privilege("我的申请查询", "/flow_myApplicationList", menu);
		session.save(menu);
		session.save(menu1);
		session.save(menu2);
		session.save(menu3);
...
//		Installer installer = (Installer)context.getBean(Installer.class);
//		installer.install();
//	}
}
